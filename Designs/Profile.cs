...
{
    public partial class Profile : Krypton.Toolkit.KryptonForm
    {
        ...
        //100% Working
        private void UpdateFieldIfModified(Krypton.Toolkit.KryptonTextBox textBox, string fieldName)
        {
        ...
        private void ClearIfPreloadedData(Krypton.Toolkit.KryptonTextBox textBox, string preloadedData)
        {
